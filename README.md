...
&emsp;&emsp;注意：U盘拖拽下载功能有所限制，一种固件只能对应一系列单片机。烧录的是 stm321103xb_if 接口固件，因此，只支持 stm321103xb 系列单片机拖拽下载。如果你想要拖拽下载 STM32F401re 系列单片机程序，则必须将固件更新为 STM32F401re 的接口固件
